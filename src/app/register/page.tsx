...
import { Store, Loader2, KeyRound, Mail, User as UserIcon } from 'lucide-react';
      ...
      >
        ...
        <form className="mt-4 space-y-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-700 block mb-3">I want to:</label>
              <div className="flex gap-4">
                <button
                  type="button"
                  onClick={() => setValue('role', 'BUYER')}
                  className={`flex-1 py-3 px-4 border rounded-xl text-sm font-semibold transition-all ${
                    selectedRole === 'BUYER' ? 'bg-green-50 border-green-500 text-green-700 shadow-sm' : 'bg-white border-gray-200 text-gray-600 hover:border-green-300'
                  }`}
                >
                  Buy Posts
                </button>
                <button
                  ...
                  className={`flex-1 py-3 px-4 border rounded-xl text-sm font-semibold transition-all ${
                    selectedRole === 'SELLER' ? 'bg-green-50 border-green-500 text-green-700 shadow-sm' : 'bg-white border-gray-200 text-gray-600 hover:border-green-300'
                  }`}
                >
                  Sell Posts
                </button>
          ...
          <button
            type="button"
            onClick={() => googleSignIn('google', { callbackUrl: `/dashboard/setup?role=${selectedRole}` })}
