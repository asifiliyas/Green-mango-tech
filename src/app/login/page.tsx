          ...
          <div className="space-y-3">
             <div className="flex gap-2 p-1 bg-gray-100 rounded-xl">
               <button 
                 ...
                 className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${googleRole === 'BUYER' ? 'bg-white shadow-sm text-green-600' : 'text-gray-500'}`}
               >
                 I want to Buy
               </button>
               <button 
                 ...
                 className={`flex-1 py-2 text-xs font-bold rounded-lg transition-all ${googleRole === 'SELLER' ? 'bg-white shadow-sm text-green-600' : 'text-gray-500'}`}
               >
                 I want to Sell
               </button>
             </div>
             ...
             <button
              type="button"
              onClick={() => googleSignIn('google', { callbackUrl: `/dashboard/setup?role=${googleRole}` })}
